...
const createB2BCustomer = async (req, res) => {
  try {
    ...
    const b2bCustomer = await B2BService.createB2BCustomer(name, email, phone, password);
    return ResponseUtil.success(res, b2bCustomer, 'B2B customer created successfully');
  } catch (error) {
...
const getAllB2BCustomers = async (req, res) => {
  try {
    ...
    return ResponseUtil.success(res, result, 'B2B customers fetched successfully');
  } catch (error) {
    return ResponseUtil.error(res, error.message || "Internal server error");
  }
};
...
const getB2BCustomerById = async (req, res) => {
  try {
    ...
    return ResponseUtil.success(res, b2bCustomer, 'B2B customer fetched successfully');
  } catch (error) {
    return ResponseUtil.error(res, error.message || "Internal server error");
  }
};
...
const updateB2BCustomer = async (req, res) => {
  try {
    ...
    return ResponseUtil.success(res, b2bCustomer, 'B2B customer updated successfully');
  } catch (error) {
    return ResponseUtil.error(res, error.message || "Internal server error");
  }
};
...
const updateB2BCustomerPassword = async (req, res) => {
  try {
    ...
    if (newPassword !== confirmPassword) {
      return ResponseUtil.error(res, "New password and confirm password do not match");
    }
...
const updateB2BCustomerStatus = async (req, res) => {
  try {
    ...
    const b2bCustomer = await B2BService.updateB2BCustomerStatus(parseInt(id), isActive);
    return ResponseUtil.success(res, b2bCustomer, 'B2B customer status updated successfully');
  } catch (error) {
    return ResponseUtil.error(res, error.message || "Internal server error");
  }
};
...
const deleteB2BCustomer = async (req, res) => {
  try {
    ...
    return ResponseUtil.success(res, result, 'B2B customer deleted successfully');
  } catch (error) {
    return ResponseUtil.error(res, error.message || "Internal server error");
  }
};
